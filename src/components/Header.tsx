...
const Header = () => {
  return (
    <div className='min-h-screen pb-20 overflow-hidden bg-no-repeat bg-cover  bg-[url("/hero-bgMain.png")]'>
      ...
      {/* hero top */}
      <div className='flex pt-40 z-10 relative flex-col items-center space-y-10 text-center lg:w-[1091px] mx-auto'>
      ...
      {/* hero bottom */}
      <div className='mt-[87px] lg:w-[1132px] z-10 relative mx-auto flex flex-col gap-10 lg:flex-row items-center justify-between text-center'>
